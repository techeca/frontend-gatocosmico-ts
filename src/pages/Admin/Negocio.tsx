...
export default function Negocio() {
    ...
    return (
        <div className="flex flex-col lg:flex-row justify-center gap-3 w-full p-6">
            ...
            <motion.div
                className="w-full lg:w-3/5 gap-6"
                variants={cardVariants}
                initial="hidden"
                animate="visible"
                custom={0.3}
                        ...
                        <div className="flex flex-col md:grid md:grid-cols-3 gap-2 w-full">
                            <div className="shadow-md cursor-pointer border-t-2 border-red-500/60 hover:border-red-500 bg-slate-50 dark:bg-zinc-900 rounded-xl px-6 pb-4 pt-6 flex flex-col">
                                <div className="flex justify-between">
                                    <h1 className="flex flex-col text-zinc-800 dark:text-zinc-100 text-base font-semibold">Inventario
                                        <span className="text-sm font-light text-zinc-500 dark:text-zinc-400">Sistema para gestión de productos.</span></h1>

                                </div>
                                <div className="flex my-3">
                                    <div className="flex justify-center items-center gap-3">
                                        <p className="font-semibold text-zinc-800 dark:text-zinc-500">Estado:</p>
                            ...
                            <div className="shadow-md cursor-pointer border-t-2 border-blue-500/60 hover:border-blue-500 dark:bg-zinc-900 bg-slate-50 rounded-xl px-6 pb-4 pt-6 flex flex-col">
                                <div className="flex justify-between">
                                    <h1 className="flex flex-col dark:text-zinc-100 text-zinc-800 text-base font-semibold">Agendamiento
                                        <span className="text-sm font-light text-zinc-500 dark:text-zinc-400">Sistema para gestión de productos.</span></h1>
                            ...
                            <div className="shadow-md cursor-pointer border-t-2 border-green-500/60 hover:border-green-500 dark:bg-zinc-900 bg-slate-50 rounded-xl px-6 pb-4 pt-6 flex flex-col">
                                <div className="flex justify-between">
                                    <h1 className="flex flex-col dark:text-zinc-100 text-zinc-800 text-base font-semibold">Atención Médica
                                        <span className="text-sm font-light text-zinc-500 dark:text-zinc-400">Sistema para gestión de productos.</span></h1>
