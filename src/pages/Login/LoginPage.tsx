...
export default function LoginPage() {
    ...
    return (
      <div>
        <div className="relative flex cursor-pointer items-center overflow-hidden rounded-xl border-slate-800 p-[1.5px] transform transition duration-500 ease-in-out translate-y-10 opacity-0 animate-fade-in-down">
